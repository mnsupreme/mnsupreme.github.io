...
<h3 class="project_title"><a href='https://github.com/mnsupreme/bigred' target="_blank" class="project_link">Subletr Big Red Hacks Fall 2016</a></h3><p class="project_description">This app helped people find places to sublease. It was written in MEAN (MongoDB, Express, Angular, Node.js) stack. I wrote 40% of the node server, most of the angular and all of the MongoDB. I also deployed the project on an Amazon EC2 instance as well as helped some of the newer memebers. At first glance, this app may seem simple and may have a few bugs. However, it was an impressive feat of team work considering that all my teammates had never been to a hackathon or used MEAN stack before. Over half of the team had never had any exposure to web development or front end development.  Yet, we were able deploy a full web app complete with front end frame work and database on an Amazon EC2 server within 36 hours.</p>
