var Skills = "<p>Credentials:</p>" + "<ul>" + "<li> Purdue University: Bachelors of Science Computer Information Technology <ul> <li>Concentration: Cyber Security</li><li>Expected Graduation Date: May 2019</li></ul></li>" + "<li>General Assembly Vocational Certificate in Front End Web Development</li>" + "<li>Coding Dojo Vocational Certificate Web Development</li>" + "<li>Stanford Machine Learning Certificate issued by Coursera</li>" +"</ul>" + "<p>Skills:</p>"+ "<ul>" + "<li>HTML</li>" + "<li>CSS</li>" + "<li>bootstrap</li>" + "<li>javascript</li>" + "<li>jquery</li>" + "<li>Python</li>" + "<li>SQL</li>" + "<li>MEAN stack (MongoDB, Express, Angular, Node.js)</li>" + "<li>Hapi.js</li>" + "<li>Handlebars</li>" + "<li>Unit Testing</li>" + "</ul>" + "<p>Involvements:</p>" +"<ul>" + "<li>Purdue Student Chapter of Association for Unmanned Vehicles International: President (2016-2017), Vice President (2017-present)</li>" + "<li>Purdue Hackers(2015-present)</li>"  + "</ul>"
