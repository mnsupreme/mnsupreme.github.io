var Skills = "<p>Credentials:</p>" + "<ul>" + "<li> Purdue University: Bachelors of Science Computer Information Technology <ul> <li>Expected Graduation Date: May 2019</li></ul></li>" + "<li>General Assembly Vocational Certificate in Front End Web Development</li>" + "<li>Coding Dojo Vocational Certificate Web Development</li>" + "</ul>" + "<p>Skills:</p>"+ "<ul>" + "<li>Front End Web Development</li>" + "<li>Python</li>" + "<li>MEAN stack</li>" + "<li>Ruby</li>" + "</ul>" + "<p>Involvements:</p>" + "<ul>" + "<li>President of Purdue Student Chapter of Association for Unmanned Vehicles International (2016-present)</li>" + "<li>Purdue Hackers(2015-present)</li>"  + "</ul>"
...
var Project = "<ul style='list-style-type:none;'> <li><h3><a href='http://devpost.com/software/lahacks-gap'>LA Hacks Gap Tech Challenge (1st place winner)</a></h3> <p>This project was created at LA Hacks 2015 for Gap with the goal of using web development to better engage their customers. Gap would host a " + "\"who wore it better contest\" " + "on Instagram where users would mark their submissions with a certain hashtag. Our web app would then scrape Instagram for this hashtag and send it to a mock employee console. I wrote most of the front end (two web pages) in bootstrap as well as embed the Instagram posts (from their api) into the front end using iframes. It is important to note that because this was our first hackathon, the documentation for the project was not to good. I am not marked as a contributor on Github and the Devpost submission does not mark us as winners even though we did win first place.</p></li> <li><h3><a href='"
